...
from gui_help_popover import HelpPopoverController

try:
    import p_04_00_wikidata_core as core
except Exception as exc:  # pragma: no cover
    raise SystemExit(
        "ERROR: Could not import p_04_00_wikidata_core.py.\n"
...
def main() -> int:
    ...
    state_file = _THIS_DIR / ".p_04_01_wikidata_gui_state.json"
