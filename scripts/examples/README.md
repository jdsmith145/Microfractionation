...
`04_fraction_predictor` includes both the standard matched-RT-pairs example and a feature-order alignment example. The feature-order example demonstrates the anchor-pair table used when HRMS and HPLC gradients are not comparable.
