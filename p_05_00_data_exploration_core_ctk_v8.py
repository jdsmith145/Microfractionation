...
def run_pipeline(config: dict[str, Any]) -> dict[str, Any]:
    ...
    summary_path = output_dir / "data_exploration_summary.json"
...
def template_config() -> dict[str, Any]:
    return {
        "base_dir": ".",
        "output_dir": "Outputs_data_exploration",
        "run_steps": {
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    parser.add_argument("--output-dir", default="Outputs_data_exploration", help="Output directory.")
